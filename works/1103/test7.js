...
function regexCheck(){
  ...
  //   alert("7.영문 대문자를 포함안하고 있습니다.");
  //   return false;
  // }

  // else if(regex8.test(content)) {
  //   alert("8.숫자를를 포함하고 있습니다.");
  //   return false;
  // }
  
  // else if(regex9.test(content)) {
  //   alert("9.숫자를를 포함안하고 있습니다.");
  //   return false;
  // }
  ...
  //   alert("11.영문 '대/소문자'나 '숫자'를 포함하고 있습니다.");
  //   return false;
  // }

  // else if(regex12.test(content)) {
  //   alert("12.영문 '대/소문자'나 '숫자'를 포함안하고 있습니다.");
  //   return false;
  // }

  // else if(regex13.test(content)) {
  //   alert("13.영문 '대/소문자'나 '숫자'를 포함안하고 있습니다.");
  //   return false;
  // }
